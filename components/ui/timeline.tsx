...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  // TODO add add another breakpoint for each item. One would be the start date and the another would the end data
    ...
    <div className="w-full bg-white dark:bg-neutral-950 font-sans md:px-10" ref={containerRef}>
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        <p className="text-neutral-700 dark:text-neutral-300 text-sm md:text-base max-w-sm">
          I&apos;ve been working in digital solutions for the past 2 years. Here&apos;s a timeline of my professional journey.
        </p>
      </div>
